    ...
    <View className="flex-1 relative bg-black">
      ...
      >
        ...
        >
          ...
          {activeTab === "home" && (
            <>
              {/* (your existing image + event content exactly as before) */}
        ...
        <View className="flex-row justify-around items-center px-8">
          ...
          >
            ...
            <Text
              ...
              style={{ fontWeight: activeTab === "home" ? "600" : "400" }}
            >
              Home
            </Text>
          </TouchableOpacity>
          ...
          >
            <View
              className={`w-10 h-10 rounded-full items-center justify-center ${
                activeTab === "friends" ? "bg-white/20" : ""
              }`}
            >
              <Text
                className={`text-2xl ${
                  activeTab === "friends" ? "text-white" : "text-white/40"
                }`}
              >
                👥
              </Text>
            ...
            <Text
              ...
              style={{ fontWeight: activeTab === "friends" ? "600" : "400" }}
            >
              Friends
            </Text>
          </TouchableOpacity>
